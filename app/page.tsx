...
<div className="origin"><img src="https://images.unsplash.com/photo-1515694590185-73647ba02c10?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" /><div className="body"><h3>Guji</h3><p>Fruity, complex and clean with vibrant acidity.</p><span className="pill">Fruity • Complex</span></div></div>
<div className="origin"><img src="https://images.unsplash.com/photo-1561986845-fbeb7f7913d8?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" /><div className="body"><h3>Sidamo</h3><p>Balanced, sweet and aromatic with fruit character.</p><span className="pill">Balanced • Sweet</span></div></div>
...
<div className="origin"><img src="https://images.unsplash.com/photo-1599766676337-49a81ed46552?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" /><div className="body"><h3>Jimma</h3><p>Full-bodied with earthy tones and sweet finish.</p><span className="pill">Nutty • Chocolate</span></div></div>
<div className="origin"><img src="https://images.unsplash.com/photo-1703646619157-eb553d16d402?q=80&w=1631&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" /><div className="body"><h3>Lekempti</h3><p>Bright, clean and balanced with fruit character.</p><span className="pill">Bright • Clean</span></div></div>
</div></div></div></section>
...
<section><div className="container twopanels"><div id="buyers" className="panel"><img src="https://images.unsplash.com/photo-1667900692644-bdc14c0d5463?q=80&w=1074&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" /><h3>For Buyers</h3><p>Find the right coffee, from the right source. Tell us your requirements and we will match you with suitable Ethiopian coffees and supply partners.</p><a className="btn green" href="#buyer-form">Submit Buyer Inquiry →</a></div><div id="suppliers" className="panel"><img src="https://images.unsplash.com/photo-1524350876685-274059332603?auto=format&fit=crop&w=1000&q=85" /><h3>For Suppliers</h3><p>Showcase your coffee to qualified international buyers and build long-term commercial relationships.</p><a className="btn green" href="#supplier-form">Supplier Registration →</a></div></div></section>
